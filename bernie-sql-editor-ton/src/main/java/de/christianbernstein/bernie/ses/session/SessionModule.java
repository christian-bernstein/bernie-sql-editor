...
import de.christianbernstein.bernie.ses.session.in.ValidateSessionsPacketData;
import de.christianbernstein.bernie.ses.session.out.ValidateSessionsResponsePacketData;
