...
package de.christianbernstein.bernie.ses.auth.in;
 ...
 */
@Getter
@PacketMeta(dataID = "CredentialsLoginPacketData", protocol = "login")
@AllArgsConstructor
public class CredentialsLoginPacketData extends PacketData {
